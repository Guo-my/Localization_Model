...
class Dist_last_Block(nn.Module):
    def __init__(self, in_feature, out_feature):
        ...
        self.line1 = nn.Linear(32, out_feature)
        self.line2 = nn.Linear(32, out_feature)
        self.line3 = nn.Linear(32, out_feature)
        self.line4 = nn.Linear(32, out_feature)
        self.line5 = nn.Linear(32, out_feature)
        self.line6 = nn.Linear(32, out_feature)
        self.line7 = nn.Linear(32, out_feature)
        self.line8 = nn.Linear(32, out_feature)
        self.line9 = nn.Linear(32, out_feature)
    ...
    def forward(self, x):
        ...
        output = torch.stack((y1, y2, y3, y4, y5, y6, y7, y8, y9), dim=1)
        return output


class class_our_bazi_net(nn.Module):
    def __init__(self):
        super().__init__()
        # distance
        ...
        self.distance_last = Dist_last_Block(5632, 4)
